...
export const cotizacionesApi = {
  ...
  recalcularDesdeListaPrecios: (id: number) =>
    api.post(`/cotizaciones/${id}/recalcular-precios`).then((r) => r.data),
};
...
export const despachosApi = {
  ...
  agregarLinea: (id: number, data: { cotizacionId: number; productoId: number; cantidad: number; precioUnitario?: number }) =>
    api.post(`/despachos/${id}/lineas`, data).then((r) => r.data),
...
export const reportesApi = {
  ...
  ventasProductoFacturas: (params: { q?: string; desde?: string; hasta?: string }) =>
    api.get("/reportes/ventas-producto-facturas", { params }).then((r) => r.data),
  ventasFacturas: (params?: { desde?: string; hasta?: string }) =>
    api.get("/reportes/ventas-facturas", { params }).then((r) => r.data),
  dineroRecibido: (params?: { desde?: string; hasta?: string }) =>
    api.get("/reportes/dinero-recibido", { params }).then((r) => r.data),
